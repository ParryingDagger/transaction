# Requirements of Transaction Management Application
...
* If you use external libraries outside the standard JDK, list them in README and explain their purpose
